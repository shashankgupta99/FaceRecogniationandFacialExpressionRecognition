"""FaceRecogniationandFacialExpressionRecognition URL Configuration
...
from frafer.views import login, registration, logout,findfacialexpression
...
urlpatterns = [
    ...
    path('findfacialexpression/',findfacialexpression,name='loginaction'),
